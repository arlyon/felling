...
public class EventHandler {
    ...
    public static class FellingEventHandler {
         ...
         */
        private static boolean shouldBreak(TreePart blockType) {
         ...
         * @return
         */
        private static boolean tryBreakBlock(IBlockState blockState, BlockPos blockPosition, World world, ItemStack mainHandItem, EntityPlayer thePlayer, TreePart treePart) {
        ...
        private static void fellingAlgorithm(IBlockState blockState, BlockPos blockPosition, World world, ItemStack mainHandItem, EntityPlayer thePlayer, TreePart treePart, EnumFacing[] directions) {
